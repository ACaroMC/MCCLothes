...
namespace PruebaNetCore.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                //var user = CreateUser(); //Vamos a utilizar UsuarioAplicacion
                ...
                if (result.Succeeded) //Cuando el usuario se crea por primera vez exitosamente 
                {
                    ...
                    await _emailSender.SendEmailAsync(Input.Email, "Confirmar tu email",
                        $"Confirmar su cuenta <a href='{HtmlEncoder.Default.Encode(callbackUrl)}'>Click aquí</a>.");
